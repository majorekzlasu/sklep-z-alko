...
class ChangePasswordForm(SetPasswordForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['new_password1'].help_text = '<ul class="form-text text-muted small"><li>Twoje hasło musi mieć minimum 8 znaków!</li></ul>'
...
class UpdateUserForm(UserChangeForm):
	...
	first_name = forms.CharField(label="", max_length=20, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Imię'}), required=False)
	last_name = forms.CharField(label="", max_length=20, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Nazwisko'}), required=False)
...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li>Twoje hasło musi mieć minimum 8 znaków!</li></ul>'

		self.fields['password2'].widget.attrs['class'] = 'form-control'
		self.fields['password2'].widget.attrs['placeholder'] = 'Potwierdź hasło'
		self.fields['password2'].label = ''
		self.fields['password2'].help_text = '<span class="form-text text-muted"><small>Potwierdź swoje hasło</small></span>'